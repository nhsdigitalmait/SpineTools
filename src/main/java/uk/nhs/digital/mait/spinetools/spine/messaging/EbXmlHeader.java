            ...
            throws Exception
    {
        synchronized (EBXMLHEADERTEMPLATE) {
            if (ebxmlheadertemplate == null) {
                StringBuilder sb = new StringBuilder();
                try {
                    BufferedReader br = new BufferedReader(new InputStreamReader((uk.nhs.digital.mait.spinetools.spine.messaging.SpineHL7Message.class.getResourceAsStream(EBXMLHEADERTEMPLATE))));
                    String line = null;
