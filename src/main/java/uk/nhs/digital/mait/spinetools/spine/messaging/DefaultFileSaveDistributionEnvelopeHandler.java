            ...
            throws FileNotFoundException, IllegalArgumentException
    {
        ...
        if (!fileSaveDirectory.exists()) {
            if (!fileSaveDirectory.mkdir()){
                throw new FileNotFoundException("Default ITK distribution envelope handler save location ("+ fileSaveDirectory + ") does not exist");
            }
        }
        if (!fileSaveDirectory.isDirectory()) {
            throw new IllegalArgumentException("Default ITK distribution envelope handler save location ("+ fileSaveDirectory + ") must be a directory");
        }
        if (!fileSaveDirectory.canWrite()) {
            throw new IllegalArgumentException("Default ITK distribution envelope handler save location ("+ fileSaveDirectory + ") must be writable");
        }       
