...
//        }
    ...
    private void loadUrlResolver(String f)
    {
        ...
        {
            SpineToolsLogger.getInstance().log("uk.nhs.digital.mait.spinetools.spine.connection.SDSSpineEndpointResolver.loadUrlResolver", e);
        }        
    }
    ...
    private ArrayList<SdsTransmissionDetails> ldapGetTransmissionDetails(String s, String o, String a, String p) 
    {
        ...
        try {
            ...
            SpineToolsLogger.getInstance().log("uk.nhs.digital.mait.spinetools.spine.connection.SDSSpineEndpointResolver.ldapGetTransmissionDetails.NamingException", e);            
            return null;
        }
        catch (Exception enull) {
            SpineToolsLogger.getInstance().log("uk.nhs.digital.mait.spinetools.spine.connection.SDSSpineEndpointResolver.ldapGetTransmissionDetails.Exception", enull);
            return null;
        }
